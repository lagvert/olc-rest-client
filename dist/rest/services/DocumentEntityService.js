...
class DocumentEntityService extends ConnectService.ConnectService {
    ...
    fetchDocumentMetadata(documentId) {
        return this.fetchProperties(`document metadata ${documentId}`, DOCUMENTS_PATH, [documentId]);
    }
    ...
    updateDocumentMetadata(documentId, properties) {
        return this.updateProperties(documentId, properties, `update metadata Doc ${documentId}`, DOCUMENTS_PATH, [documentId]);
    }
}
